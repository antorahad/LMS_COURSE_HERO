                                    ...
                                    {menuToggle &&
                                        <div className='absolute right-0 w-52 bg-slate-50 p-5 mt-2 rounded-[5px] shadow-sm flex flex-col items-center justify-center'>
                                            ...
                                            <ul className='flex flex-col items-center justify-center'>
                                                <li className='py-3'><Link to='/dashboard'>Dashboard</Link></li>
                                                <li className='py-3'><Link to='/profile'>Profile</Link></li>
                                                <li className='py-3'><Link to='/settings'>Settings</Link></li>
                                                <li className='py-3'>
                        ...
                        {menuToggle &&
                            <div className='fixed top-0 right-0 w-full h-full bg-gray-900 bg-opacity-90 flex items-center justify-center z-50'>
                                <div className='w-4/5 bg-white p-5 rounded-[5px] shadow-lg'>
                                    ...
                                    <p className='mb-3 flex items-center justify-center'>{user.email}</p>
                                    <ul className='flex flex-col items-center justify-center'>
                                        <li className='py-3'><Link to='/dashboard'>Dashboard</Link></li>
                                        <li className='py-3'><Link to='/profile'>Profile</Link></li>
                                        <li className='py-3'><Link to='/settings'>Settings</Link></li>
                                        <li className='py-3'><button onClick={handleSignout} className='bg-gradient-to-r from-violet-300 to-purple-300 px-[28px] py-[12px] rounded-[5px] text-white text-[14px] font-[600] border-none outline-none'>Sign Out</button></li>
                                    </ul>
                                </div>
                            </div>
                        }
